...
## 💡 延伸性問題建議（您可以直接複製詢問）
1. 「[針對個案命盤最具張力宮位或格局之具體追問範例一]」
2. 「[針對個案命主星轉化或相位挑戰之具體追問範例二]」
3. 「[針對個案大運流年轉折時機之具體追問範例三]」
4. ✍️ 自行輸入問題（若您有其他具體關心的領域、特定決策或任何疑惑，歡迎直接輸入提問）
...
- 解釋完畢後，在最後必須放入「## 💡 延伸性問題建議（您可以直接複製詢問）」，包含 3 個為個案量身定制、以「引號」標註的深入追問，以及第 4 項「✍️ 自行輸入問題（若您有其他具體關心的領域、特定決策或任何疑惑，歡迎直接輸入提問）」，避免使用者感到被侷限於固定選項。
"""
